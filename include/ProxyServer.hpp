...
class ProxyServer {
   public:
    ...
    ProxyServer(const std::string& server_ip, int server_port, const std::string& sql_servre_ip,
   ...
   private:
    ...
    bool forwardToServer(int client_socket_fd,
                         Client& client);  // method to forward data from the client to the SQL server
